<template>
  <div class="rkhy-slider"
    :class="{ 'is-vertical': vertical, 'rkhy-slider--with-input': showInput }"
     role="slider"
     :aria-valuemin="min"
     :aria-valuemax="max"
  ...
  >
    ...
    <div class="rkhy-slider__runway"
      :class="{ 'show-input': showInput, 'disabled': disabled }"
      :style="runwayStyle"
      @click="onSliderClick"
      ref="slider">
      <div
        class="rkhy-slider__bar"
        :style="barStyle">
      </div>
      <slider-button
        :vertical="vertical"
